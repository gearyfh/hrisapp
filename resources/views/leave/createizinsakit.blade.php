...
<div class="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-6">
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">Form Pengajuan Izin / Sakit</h1>
    ...
    <form action="{{ route('leave.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            <label class="block text-gray-700 font-medium">Jenis Pengajuan</label>
        ...
        <div>
            ...
            <textarea name="reason" rows="3"
                ...
                placeholder="Tuliskan alasan pengajuan">{{ old('reason') }}</textarea>
        </div>

        <div>
            <label class="block text-gray-700 font-medium">Lampiran Surat Dokter (Khusus Sakit)</label>

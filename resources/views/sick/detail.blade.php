...
<div class="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-6">
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold text-gray-800">Detail Pengajuan Izin / Sakit</h1>
        <a href="{{ route('sick.index') }}" class="text-blue-600 hover:underline">← Kembali</a>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            <p class="text-gray-600">Jenis Izin / Sakit:</p>
        ...
        <div class="col-span-2">
            <p class="text-gray-600">Alasan Izin / Sakit:</p>
            <p class="font-semibold">{{ $leave->reason ?? '-' }}</p>
        </div>

        @if($leave->attachment)
        <div class="col-span-2">
            <p class="text-gray-600">Lampiran Surat Dokter / Bukti:</p>
    ...
    <div class="mt-6 text-right text-sm text-gray-500">
        <p>Disetujui oleh: {{ $leave->approved_by ?? '-' }}</p>
        <p>Pada: {{ $leave->approved_at ?? '-' }}</p>
    </div>
</div>
@endsection
